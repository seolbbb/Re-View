...
if __name__ == "__main__":
    ...
    output_folder = r"C:\Users\irubw\geminiProject\screentime_mvp\captured_frames_masked"
    
    processor = VideoProcessor()
    # threshold와 min_interval은 영상 특성에 따라 조절 필요
    # 강의 영상은 슬라이드가 확 바뀌므로 threshold 30 정도면 적당할 듯 -> 10으로 하향 조정
    # capture_duration을 5초로 늘려서 마우스 제거 성능 향상
