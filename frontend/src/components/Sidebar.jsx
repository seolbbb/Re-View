...
function Sidebar({ isOpen, onClose }) {
    ...
    return (
        <>
            ...
            <aside className={`fixed lg:static inset-y-0 left-0 w-64 flex flex-col bg-surface border-r border-[var(--border-color)] shrink-0 z-50 transition-transform duration-300 transform ${isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'} h-full overflow-y-auto custom-scrollbar`}>
